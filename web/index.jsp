    ...
    <div id="nav">
      ...
      <div class="nav1">
        <ul class="nav2">
          ...
          <li class="li"><a href="javascript:void(0)">图书管理</a>
            <ul class="nav3">
              <li><a href="./book_add.jsp" target="main">添加图书</a></li>
              <li><a href="./book.let?type=query&pageIndex=1" target="main">图书删改</a></li>
              <!--				     <li><a href="###">吴</a></li>		   -->
              <!--				     <li><a href="###">Rin</a></li>		   -->
            </ul>
          </li>
          <li class="li"><a href="javascript:void(0)">图书类型管理</a>
            <ul class="nav3">
              <li><a href="type_add.jsp" target="main">添加类型</a></li>
              <li><a href="type_list.jsp" target="main">删改类型</a></li>
              <!--				     <li><a href="###">陈</a></li>		   -->
            </ul>
          </li>
          <li class="li"><a href="javascript:void(0)">常用操作</a>
            <ul class="nav3">
              <li><a href="./book_rent.jsp" target="main">借书</a></li>
